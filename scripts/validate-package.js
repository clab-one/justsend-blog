...
const required = [
  ...
  "schemas/research-pack.schema.json", "schemas/evidence-pack.schema.json", "schemas/visual-plan.schema.json", "schemas/quality-contract.schema.json", "schemas/audit-report.schema.json",
  "policies/writing-policy.yml", "templates/research-source.md", "scripts/validate-research.js", "THIRD_PARTY_NOTICES.md", "upstreams.lock.yml",
...
for (const name of ["research-pack", "evidence-pack", "visual-plan", "quality-contract", "audit-report", "run-manifest"]) {
