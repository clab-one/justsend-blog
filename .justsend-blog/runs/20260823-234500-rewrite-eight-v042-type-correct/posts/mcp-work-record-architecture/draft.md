...
새 run은 MCP 재설계 기록, 현재 workStart와 AgentSidecarStore, MCP Tools specification, 로그인 전 runtime 관측을 다시 읽었다. 기존 공개 글은 corpus로만 사용하고 새 Evidence는 JS-E101부터 다시 만들었다.
<!-- evidence: JS-E107 -->
