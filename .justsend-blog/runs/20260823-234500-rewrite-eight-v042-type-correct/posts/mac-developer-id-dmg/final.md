...
새 run에서는 현재 `PLAN-DIRECT-DISTRIBUTION.md`, package script, Apple notarization 문서, DMG·helper runtime 관측을 다시 읽었다. 중간 시도의 “bundle helper” 결론을 현재형으로 복사하지 않고 현재 정본인 App DMG와 helper ZIP 분리를 기준으로 썼다.
<!-- evidence: JS-E107 -->
