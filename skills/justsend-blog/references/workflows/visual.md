...
10. `visual_candidate: true` section이 모두 render decision과 실제 SVG로 덮였는지 확인한다. 누락·false 하향·omit, 의미상 최적 type과 plan type 불일치, renderer metadata 불일치, type invariant 위반은 audit FAIL이다.
